...
public class EmpController {
	...
	/*
	  ...
	  @RequestMapping(value = "/editemp/{id}")
	    public String editEmployee(@ModelAttribute("emp") Emp emp,@PathVariable("id") int id)
	    {
	...
	public String editsave(@PathVariable int id,  Emp emp){   
		 dao.update(emp);    
		 return "redirect:/viewemp";
	...
	*/
	@RequestMapping(value = "/editsave/{id}",method=RequestMethod.POST)
    public ModelAndView editsave(@ModelAttribute int id, Emp emp)
    {
        try
        {
            if(dao.getEmpById(emp.getId()) != null);
            dao.update(emp);
        }
...
/*	 
	 ...
	 @RequestMapping(value = "/deleteemp/{id}")
	    public ModelAndView delete(@ModelAttribute Emp emp,@PathVariable("id") int id)
	    {
	        dao.delete(id);
